<div
  ...
  <div
    class="shadow-sm off-canvas-menu-close dashboard-menu-close icon-element icon-element-sm"
  ...
  <ul
    ...
    <li><a href="{{ route("user.profile") }}"><svg class="mr-2"
          xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
          width="18px">
          <path d="M0 0h24v24H0V0z" fill="none" />
          <path
    ...
    <li><a href="dashboard-courses.html"><svg class="mr-2"
          xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
          width="18px">
          <path d="M0 0h24v24H0V0z" fill="none" />
          <path
    ...
    <li><a href="dashboard-quiz.html"><svg class="mr-2"
    ...
    <li><a href="{{ route("user.wishlist") }}"><svg class="mr-2"
        ...
        </svg> Wishlist <span class="p-1 ml-2 badge badge-info"
          id="wishlistQty"></span></a>
    </li>
    <li><a href="dashboard-message.html"><svg class="mr-2"
          xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
          width="18px">
          <path d="M0 0h24v24H0V0z" fill="none" />
          <path
    ...
    <li><a href="dashboard-reviews.html"><svg class="mr-2"
          xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
          width="18px">
          <path d="M0 0h24v24H0V0z" fill="none" />
          <path
    ...
    <li><a href="{{ route("user.logout") }}"><svg class="mr-2"
          xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24"
          width="18px">
          <path d="M0 0h24v24H0V0z" fill="none" />
          <path
...
<div class="dashboard-content-wrap">
  <div
    class="mb-4 ml-3 dashboard-menu-toggler btn theme-btn theme-btn-sm lh-28 theme-btn-transparent">
