  ...
  <div class="page-content">
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Site Setting
            </li>
          </ol>
        </nav>
      </div>
    ...
    <div class="card">
      <div class="card-body p-4">
        ...
        <form id="myForm" action="{{ route('update.site') }}" method="post"
