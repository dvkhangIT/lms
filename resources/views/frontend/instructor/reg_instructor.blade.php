@extends("frontend.master") @section("home")
    ...
    <div class="container">
      ...
      <div class="row pt-60px">
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box before-none">
            <div class="mx-auto shadow-sm icon-element">
              <svg class="svg-icon-color-1" version="1.1" viewBox="0 0 512.001 512.001"
                width="40" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                y="0px">
                <g>
                  <path
                ...
                <g>
                  <path
                    d="M263.061,45.931c-1.86-1.86-4.44-2.93-7.07-2.93s-5.21,1.07-7.07,2.93c-1.86,1.86-2.93,4.44-2.93,7.07
                        s1.07,5.21,2.93,7.07c1.86,1.86,4.44,2.93,7.07,2.93s5.21-1.07,7.07-2.93c1.86-1.86,2.93-4.44,2.93-7.07 S264.921,47.791,263.061,45.931z" />
                </g>
                <g>
                  <path
                ...
                <g>
                  <path
                    d="M365.011,310.931c-1.86-1.86-4.44-2.93-7.07-2.93s-5.21,1.07-7.07,2.93c-1.86,1.86-2.93,4.44-2.93,7.07 s1.07,5.21,2.93,7.07s4.44,2.93,7.07,2.93s5.21-1.07,7.07-2.93c1.86-1.86,2.93-4.44,2.93-7.07S366.871,312.791,365.011,310.931z" />
                </g>
                <g>
                  <path
              ...
              c0,26.885,21.873,48.758,48.758,48.758h326.483c26.885,0,48.758-21.873,48.758-48.758V87.759 C468.001,60.874,446.128,39.001,419.243,39.001z M211.501,42h15.586c4.498,0,8.442-3.003,9.639-7.338
        ...
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box before-none">
            <div class="mx-auto shadow-sm icon-element">
              <svg class="svg-icon-color-3" version="1.1" viewBox="0 0 490.667 490.667"
                width="41" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                y="0px">
                <g>
                  <g>
                    <path
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 responsive-column-half">
          <div class="counter-item">
            <div class="mb-3 shadow-sm counter__icon icon-element">
              <svg class="svg-icon-color-2" version="1.1" viewBox="0 0 480.1 480.1" width="42"
        ...
        <div class="col-lg-3 responsive-column-half">
          <div class="counter-item">
            <div class="mb-3 shadow-sm counter__icon icon-element">
              <svg class="svg-icon-color-3" version="1.1" viewBox="0 0 490.667 490.667"
                width="42" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                y="0px">
                <g>
                  <g>
                    <path
  ...
  @error("password") is-invalid @enderror"
                      name="password" placeholder="e.g. Alex" type="password" />
                    <span class="la la-user input-icon"></span>
                    @error("password")
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
  ...
  Alex" type="text" />
                ...
                <div class="btn-box col-lg-12">
                  <div class="mb-4 custom-control custom-checkbox fs-15">
                    <input class="custom-control-input" id="agreeCheckbox" required
                      type="checkbox" />
                    <label class="custom-control-label custom--control-label" for="agreeCheckbox">by
                      signing i agree to the
                      <a class="text-color hover-underline" href="terms-and-conditions.html">terms
                        and conditions</a>
                      and
                      <a class="text-color hover-underline" href="privacy-policy.html">privacy
                        policy</a>
                    </label>
                  </div>
                  <!-- end custom-control -->
