    ...
    <div class="container">
      ...
      <div class="row pt-60px">
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box before-none">
            <div class="mx-auto shadow-sm icon-element">
              <svg class="svg-icon-color-1" version="1.1"
                viewBox="0 0 512.001 512.001" width="40" x="0px"
        ...
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box before-none">
            <div class="mx-auto shadow-sm icon-element">
              <svg class="svg-icon-color-3" version="1.1"
                viewBox="0 0 490.667 490.667" width="41" x="0px"
                xml:space="preserve" xmlns="http://www.w3.org/2000/svg" y="0px">
                <g>
                  <g>
                    <path
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 responsive-column-half">
          <div class="counter-item">
            <div class="mb-3 shadow-sm counter__icon icon-element">
              <svg class="svg-icon-color-2" version="1.1"
                viewBox="0 0 480.1 480.1" width="42" x="0px"
                xml:space="preserve" xmlns="http://www.w3.org/2000/svg" y="0px">
                <g>
                  <g>
                    <path
        ...
        <div class="col-lg-3 responsive-column-half">
          <div class="counter-item">
            <div class="mb-3 shadow-sm counter__icon icon-element">
              <svg class="svg-icon-color-3" version="1.1"
                viewBox="0 0 490.667 490.667" width="42" x="0px"
                xml:space="preserve" xmlns="http://www.w3.org/2000/svg" y="0px">
                <g>
                  <g>
                    <path
