    ...
    <div id="tooltip_content_1">
      <div class="card card-item">
        <div class="card-body">
          ...
          <p class="card-text fs-14 lh-22 pt-1">The skills you need to become a BI Analyst - Statistics, Database
            theory, SQL, Tableau – Everything is included</p>
          <ul class="generic-list-item fs-14 py-3">
            <li><i class="la la-check mr-1 text-black"></i> Become an expert in Statistics, SQL, Tableau, and problem
              solving</li>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <a href="#" class="btn theme-btn flex-grow-1 mr-3"><i class="la la-shopping-cart fs-18 mr-1"></i> Add
              to Cart</a>
            <div class="icon-element icon-element-sm cursor-pointer shadow-sm" title="Add to Wishlist"><i
  ...
  <div class="tooltip_templates">
    <div id="tooltip_content_2">
      <div class="card card-item">
        <div class="card-body">
          <p class="card-text pb-2">By <a href="teacher-detail.html">Jose Portilla</a></p>
          <h5 class="card-title pb-1"><a href="course-details.html">Ultimate Adobe Photoshop Training: From Beginner
              to Pro</a></h5>
          <div class="d-flex align-items-center pb-1">
            <h6 class="ribbon fs-14 mr-2">Bestseller</h6>
            <p class="text-success fs-14 font-weight-medium">Updated<span class="font-weight-bold pl-1">November
    ...
    <div id="tooltip_content_3">
      <div class="card card-item">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <a href="#" class="btn theme-btn flex-grow-1 mr-3"><i class="la la-shopping-cart fs-18 mr-1"></i>
              Add to Cart</a>
            <div class="icon-element icon-element-sm cursor-pointer shadow-sm" title="Add to Wishlist"><i
                class="la la-heart-o"></i></div>
          </div>
