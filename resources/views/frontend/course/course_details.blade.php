...
@section("home")
      ...
      <div class="mr-auto col-lg-8">
        <div class="breadcrumb-content">
          ...
          <div class="pt-3 bread-btn-box">
            <button
              class="mb-2 mr-2 btn theme-btn theme-btn-sm theme-btn-transparent lh-28">
            ...
            <button
              class="mb-2 btn theme-btn theme-btn-sm theme-btn-transparent lh-28"
          ...
          <div class="course-details-content-wrap pt-90px">
            <div class="p-4 rounded course-overview-card bg-gray">
              ...
              <ul class="generic-list-item overview-list-item">
                <li><i class="mr-1 text-black la la-check"></i> Learn the core
                  Java skills needed to
                  apply for Java
                  developer positions in just 14 hours.</li>
                <li><i class="mr-1 text-black la la-check"></i> Be able to
                  demonstrate your
                  understanding of Java to
                  future employers.</li>
                <li><i class="mr-1 text-black la la-check"></i> Acquire essential
                  java basics for
                  transitioning to the
                  Spring Framework, Java EE, Android development and more.</li>
                <li><i class="mr-1 text-black la la-check"></i> Be able to sit for
                  and pass the Oracle
                  Java Certificate
                  exam if you choose.</li>
                <li><i class="mr-1 text-black la la-check"></i> Learn industry
                  "best practices" in
                  Java software
                  development from a professional Java developer who has worked in
                  the language for 18
                  years.</li>
                <li><i class="mr-1 text-black la la-check"></i> Obtain proficiency
                  in Java 8 and Java
                  11.</li>
              </ul>
            ...
            <div class="p-4 border rounded course-overview-card border-gray">
              <h3 class="fs-20 font-weight-semi-bold">Top companies trust Aduca
              </h3>
              <p class="pb-1 fs-15">Get your team access to Aduca's top 5,000+
                courses</p>
              <div class="pb-3">
                <img width="85" class="mr-3" src="images/sponsor-img.png"
                  alt="company logo">
                <img width="80" class="mr-3" src="images/sponsor-img2.png"
                  alt="company logo">
                <img width="80" class="mr-3" src="images/sponsor-img3.png"
                  alt="company logo">
                <img width="70" class="mr-3" src="images/sponsor-img4.png"
                  alt="company logo">
              </div>
            ...
            <div class="course-overview-card">
              ...
              <p class="pb-2 fs-15">Lorem Ipsum has been the industry’s standard
              ...
              <p class="pb-2 fs-15">It has survived not only five centuries, but
                also the leap into
                electronic
              ...
              <p class="pb-1 fs-15">- Lorem ipsum dolor sit amet, consectetur.</p>
              <p class="pb-1 fs-15">- Lorem ipsum dolor sit amet, consectetur.</p>
              <p class="pt-3 pb-2 fs-15 lh-22"><strong
                  class="text-black font-weight-semi-bold">Are
                  you aiming to get
                  your first Java Programming job but struggling to find out what
                  skills employers
                  want</strong> and which
                course will give you those skills?</p>
              <p class="pb-2 fs-15">This course is designed to give you the Java
                skills you need to
                get a job as a Java
                developer. By the end of the course, you will understand Java
                extremely well and be
                able to build your own
                Java apps and be productive as a software developer.</p>
              <div class="collapse" id="collapseMore">
                <p class="pb-2 fs-15">The core java material you need to learn
                  java development is
                  covered in the first
                  seven sections (around 14 hours in total). The Java Basics are
                  covered in those
                  sections. The rest of
                  the course covers intermediate, advanced, and optional material
                  you do not
                  technically need to go
                  through.</p>
                <h4 class="py-2 fs-20 font-weight-semi-bold">Who this course is
                  for:</h4>
                <ul class="generic-list-item generic-list-item-bullet fs-15">
            ...
            <div class="course-overview-card">
              <div
                class="pb-4 curriculum-header d-flex align-items-center justify-content-between">
                ...
                <div class="curriculum-duration fs-15">
                  <span class="mr-2 curriculum-total__text"><strong
                      class="text-black font-weight-semi-bold">Total:</strong> 17
                    lectures</span>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingOne">
                      <button
                        ...
                        Course introduction
                        <span class="fs-15 text-gray font-weight-medium">6
                          lectures</span>
                      </button>
                    </div><!-- end card-header -->
                  ...
                  <div class="card">
                    <div class="card-header" id="headingThree">
                      <button
                        ...
                        <i class="la la-minus"></i>
                        Conclusion
                        <span class="fs-15 text-gray font-weight-medium">1
                          lectures</span>
                      </button>
                    </div>
            ...
            <div class="pt-4 course-overview-card">
              <h3 class="pb-4 fs-24 font-weight-semi-bold">Students also bought
              </h3>
              <div class="view-more-carousel owl-action-styled">
                <div
                  class="border shadow-none card card-item card-item-list-layout border-gray">
                  ...
                  <div class="card-body">
                    ...
                    <div
                      ...
                      <p class="text-black card-price font-weight-bold">12.99
                        <span
                ...
                <div
                  ...
                  <div class="card-body">
                    ...
                    <div
                      class="d-flex justify-content-between align-items-center">
                      <p class="text-black card-price font-weight-bold">129.99
                      </p>
                      <div
                        class="shadow-sm cursor-pointer icon-element icon-element-sm"
                        title="Add to Wishlist"><i class="la la-heart-o"></i>
            ...
            <div class="pt-4 course-overview-card">
              <h3 class="pb-4 fs-24 font-weight-semi-bold">About the instructor
              </h3>
                ...
                <div class="media media-card">
                  <div class="instructor-img">
                    ...
                    <ul class="pt-3 generic-list-item">
                      <li><i class="mr-2 la la-star text-color-3"></i> 4.6
                        Instructor Rating</li>
                      <li><i class="mr-2 la la-user text-color-3"></i> 45,786
                        Students</li>
                      <li><i class="mr-2 la la-comment-o text-color-3"></i> 2,533
                        Reviews</li>
                      <li><i class="mr-2 la la-play-circle-o text-color-3"></i>
                        24 Courses</li>
                  ...
                  <div class="media-body">
                    ...
                    <span class="pt-2 pb-3 d-block lh-18">Joined 4 years
                      ago</span>
                    <p class="pb-3 text-black lh-18">Java Python Android and C#
                      Expert Developer -
                      878K+ students</p>
                    ...
                    <div class="collapse" id="collapseMoreTwo">
                      <p class="pb-3">After learning the hard way, Tim was
                        ...
                        best teacher he
                        could, and to make his training as painless as possible,
                        so that you, or
                        anyone else with the
                        desire to become a software developer, could become one.
                      </p>
                      <p class="pb-3">If you want to become a financial
                        analyst, a finance manager, an
                        FP&A analyst, an
                        investment banker, a business executive, an entrepreneur,
                        a business
                        intelligence analyst, a data
                        analyst, or a data scientist, <strong
                          class="text-black font-weight-semi-bold">Tim Buchalka's
            ...
            <div class="pt-4 course-overview-card">
              <h3 class="fs-24 font-weight-semi-bold pb-40px">Student feedback
              </h3>
            ...
            <div class="pt-4 course-overview-card">
              ...
              <div class="review-wrap">
                ...
                <div
                  ...
                  <div class="media-body">
                    <div
                      class="flex-wrap pb-1 d-flex align-items-center justify-content-between">
                      <h5>Kavi arasan</h5>
                      <div class="review-stars">
                        <span class="la la-star"></span>
                        <span class="la la-star"></span>
                    ...
                    <p class="pb-2">This is one of the best courses I have
                      taken in Udemy. It is very
                      complete, and it
                      has made continue learning about Java and SQL databases as
                      well.</p>
                    <div class="helpful-action">
                      <span class="d-block fs-13">Was this review helpful?</span>
                      <button class="btn">Yes</button>
                      <button class="btn">No</button>
                      <span class="pl-1 cursor-pointer btn-text fs-14"
                        data-toggle="modal"
              ...
              <div class="text-center see-more-review-btn">
                <button type="button"
                  class="btn theme-btn theme-btn-transparent">Load more
                  reviews</button>
              </div>
            </div><!-- end course-overview-card -->
            <div class="pt-4 course-overview-card">
              ...
              <form method="post" class="row">
                ...
                <div class="input-box col-lg-12">
                  ...
                  <div class="form-group">
                    <textarea class="pl-3 form-control form--control" name="message"
                ...
                <div class="btn-box col-lg-12">
                  ...
                  <button class="btn theme-btn" type="submit">Submit
                    Review</button>
                </div><!-- end btn-box -->
              </form>
            </div><!-- end course-overview-card -->
                ...
                <div class="preview-course-video">
                  <a href="javascript:void(0)" data-toggle="modal"
                    ...
                    <div class="preview-course-video-content">
                      ...
                      <p class="pt-3 text-white fs-15 font-weight-bold">Preview
                        this course</p>
                    </div>
                  </a>
                ...
                <div class="preview-course-feature-content pt-40px">
                  ...
                  <div class="preview-course-incentives">
                    ...
                    <ul class="pb-3 generic-list-item">
                      ...
                      <li><i class="mr-2 la la-code text-color"></i>51 coding
                        exercises</li>
                      <li><i class="mr-2 la la-key text-color"></i>Full lifetime
                        access</li>
                      <li><i class="mr-2 la la-television text-color"></i>Access
                        on mobile and TV</li>
                      <li><i
                          class="mr-2 la la-certificate text-color"></i>Certificate
                        of Completion
                      </li>
                    </ul>
                    <div class="section-block"></div>
                    <div class="pt-4 buy-for-team-container">
                      <h3 class="pb-2 fs-18 font-weight-semi-bold">Training 5 or
                        more people?</h3>
                      <p class="pb-3 lh-24">Get your team access to 3,000+ top
                        Aduca courses anytime,
                        anywhere.</p>
            ...
            <div class="card card-item">
              <div class="card-body">
                ...
                <ul class="generic-list-item generic-list-item-flash">
                  ...
                  <li class="d-flex align-items-center justify-content-between">
                    <span><i
                        class="mr-2 la la-bolt text-color"></i>Quizzes</span> 26
                  </li>
                  <li class="d-flex align-items-center justify-content-between">
                    <span><i class="mr-2 la la-eye text-color"></i>Preview
                      Lessons</span> 4
                  </li>
                  <li class="d-flex align-items-center justify-content-between">
                    <span><i
                        class="mr-2 la la-language text-color"></i>Language</span>
                    English
                  </li>
                  <li class="d-flex align-items-center justify-content-between">
                  ...
                  <li class="d-flex align-items-center justify-content-between">
                    <span><i
                        class="mr-2 la la-users text-color"></i>Students</span>
                    30,506
                  </li>
                  <li class="d-flex align-items-center justify-content-between">
                    <span><i
    ...
    <div class="container">
      <div class="related-course-wrap">
        <h3 class="fs-28 font-weight-semi-bold pb-35px">More Courses by <a
            href="teacher-detail.html" class="text-color hover-underline">Tim
            Buchalka</a></h3>
      ...
      <div class="row align-items-center">
        <div class="col-lg-9">
          <div class="flex-wrap py-4 cta-content-wrap d-flex align-items-center">
            <svg class="flex-shrink-0 mr-4" width="70"
              viewBox="0 -48 496 496" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <div class="section-heading">
              <h2 class="mb-1 section__title fs-22">Become a Teacher, Share your
                knowledge</h2>
              <p class="section__desc">Create an online video course, reach
        ...
        <div class="col-lg-3">
          <div class="text-right cta-btn-box">
            <a href="become-a-teacher.html" class="btn theme-btn">Tech on Aduca
      ...
      <div class="modal-content">
        <div class="modal-header border-bottom-gray">
          <h5 class="modal-title fs-19 font-weight-semi-bold"
            id="shareModalTitle">Share this course
          </h5>
  ...
  <!-- Modal -->
  <div class="modal fade modal-container" id="previewModal" tabindex="-1"
    role="dialog" aria-labelledby="previewModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header border-bottom-gray">
          <div class="pr-2">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header border-bottom-gray">
          <div class="pr-2">
            <h5 class="modal-title fs-19 font-weight-semi-bold lh-24"
              id="reportModalTitle">Report
              Abuse</h5>
            <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by Aduca
              staff to determine
              whether it violates Terms
              of Service or Community Guidelines. If you have a question or
