              ...
              <div class="card-body p-sm-5">
                <div class="">
                    ...
                    <form class="row g-3" method="POST" action="{{ route("login") }}">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group" id="show_hide_password">
                          ...
                          is-invalid
                        @enderror"
                            id="password" name="password" value="" placeholder="Enter Password"> <a
                            href="javascript:;" class="bg-transparent input-group-text"><i class="bx bx-hide"></i></a>
                        </div>
                        @error("password")
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                  ...
                  <div class="text-center list-inline contacts-social">
                    <a href="javascript:;" class="text-white border-0 list-inline-item bg-facebook rounded-3"><i
                        class="bx bxl-facebook"></i></a>
                    <a href="javascript:;" class="text-white border-0 list-inline-item bg-twitter rounded-3"><i
                        class="bx bxl-twitter"></i></a>
                    <a href="javascript:;" class="text-white border-0 list-inline-item bg-google rounded-3"><i
                        class="bx bxl-google"></i></a>
                    <a href="javascript:;" class="text-white border-0 list-inline-item bg-linkedin rounded-3"><i
