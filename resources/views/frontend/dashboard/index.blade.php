  ...
  <div class="flex-wrap mb-5 breadcrumb-content d-flex align-items-center justify-content-between">
    <div class="media media-card align-items-center">
      ...
      <div class="media-body">
        <h2 class="section__title fs-30">Hellow, {{ $profileData->name }}</h2>
      ...
      <div class="card card-item dashboard-info-card">
        <div class="card-body d-flex align-items-center">
          <div class="flex-shrink-0 text-white icon-element bg-1">
            <svg class="svg-icon-color-white" width="40" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px"
      ...
      <div class="card card-item dashboard-info-card">
        <div class="card-body d-flex align-items-center">
          <div class="flex-shrink-0 text-white icon-element bg-2">
            <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px"
              y="0px" viewBox="0 0 512 512" xml:space="preserve">
              <g>
                <g>
                  <g>
