...
@section('admin')
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Blog Post
            </li>
          </ol>
        </nav>
      </div>
      ...
      <div class="card-body p-4">
        ...
        <form id="myForm" action="{{ route('update.blog.post') }}"
          ...
          <div class="form-group col-md-12">
            ...
            <textarea name="long_descp" class="form-control" id="myeditorinstance">
              {!! $post->long_descp !!}
            </textarea>
          </div>
          <div class="form-group col-md-6">
            ...
            <input type="text" name="post_tags" class="form-control"
              data-role="tagsinput" value="{{ $post->post_tags }}">
          </div>
          <div class="col-md-6">
          </div>
          <div class="form-group col-md-6">
  ...
  <script
    src="https://cdn.tiny.cloud/1/ebz6ernns0j2t2y9dec6eeqnutsorzkjrjm0q6xrh4pp2yne/tinymce/7/tinymce.min.js"
