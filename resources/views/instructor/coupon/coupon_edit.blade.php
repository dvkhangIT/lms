  ...
  <div class="page-content">
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="p-0 mb-0 breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Instructor Edit
              Coupon </li>
          </ol>
        </nav>
      </div>
    ...
    <div class="card">
      <div class="p-4 card-body">
        ...
        <form id="myForm" action="{{ route('instructor.update.coupon') }}"
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="coupon_name" class="form-control"
              id="input1" value="{{ $coupon->coupon_name }}">
          </div>
          <div class="form-group col-md-6">
