          ...
          <div class="row g-0">
            ...
            <div
              ...
              <div class="mb-0 bg-transparent shadow-none card rounded-0">
                <div class="card-body">
                  <img
                    src="{{ asset("backend/assets/images/login-images/login-cover.svg") }}"
              ...
              <div class="m-3 mb-0 bg-transparent shadow-none card rounded-0">
                <div class="card-body p-sm-5">
                  <div class="">
                        ...
                        <div class="col-12">
                          <div class="text-center">
                            <p class="mb-0">Don't have an account yet? <a
                                href="authentication-signup.html">Sign up
                                here</a>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="mb-5 text-center login-separater"> <span>OR SIGN
                        IN WITH</span>
                      <hr>
                    </div>
