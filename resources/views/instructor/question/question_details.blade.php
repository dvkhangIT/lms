  ...
  <div class="page-content">
    <div class="chat-wrapper">
        ...
        <div class="chat-sidebar-header">
          <div class="d-flex align-items-center">
            <div class="chat-user-online">
              <img src="assets/images/avatars/avatar-1.png" width="45"
            ...
            <div class="dropdown">
              <div
                class="cursor-pointer font-24 dropdown-toggle dropdown-toggle-nocaret"
            ...
            <div class="tab-pane fade show active" id="pills-Chats">
              ...
              <div class="chat-list ps ps--active-y">
                ...
                <div class="ps__rail-y"
                  style="top: 200px; height: 300px; right: 0px;">
                  <div class="ps__thumb-y" tabindex="0"
                    style="top: 112px; height: 168px;"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="chat-content ps ps--active-y">
        ...
        <div class="ps__rail-y" style="top: 228px; height: 520px; right: 0px;">
          <div class="ps__thumb-y" tabindex="0"
