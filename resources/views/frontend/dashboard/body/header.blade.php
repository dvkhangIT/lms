            ...
            <div class="menu-wrapper">
              <form method="post" class="ml-0 mr-auto">
                <div class="mb-0 form-group">
                  <input class="pl-3 form-control form--control form--control-gray" type="text" name="search"
                      ...
                      <li>
                        ...
                        <ul class="cart-dropdown-menu after-none">
                          <li>
                            ...
                            <a href="#"
                              class="mt-3 btn theme-btn theme-btn-sm theme-btn-transparent lh-28 w-100">Add to cart
                          ...
                          <li>
                            <a href="my-courses.html" class="btn theme-btn w-100">Got to wishlist <i
                      ...
                      <li>
                        ...
                        <ul class="p-0 cart-dropdown-menu after-none notification-dropdown-menu">
                          ...
                          <li class="menu-heading-block">
                            <a href="dashboard.html" class="btn theme-btn w-100">Show All Notifications <i
                                class="ml-1 la la-arrow-right icon"></i></a>
                          </li>
                        </ul>
                      </li>
