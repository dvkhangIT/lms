      ...
      <div class="col-lg-4 responsive-column-half">
        <div class="card card-item hover-s text-center">
          <div class="card-body">
            ...
            <h5 class="card-title pb-2 pt-4">Become an Instructor</h5>
        ...
        <div class="card card-item hover-s text-center">
          <div class="card-body">
            <img src="images/img-loading.png" data-src="images/small-img-3.jpg" alt="card image"
              class="img-fluid lazy rounded-full">
            <h5 class="card-title pb-2 pt-4">Become a Learner</h5>
        ...
        <div class="card card-item hover-s text-center">
          <div class="card-body">
            <img src="images/img-loading.png" data-src="images/small-img-4.jpg" alt="card image"
              class="img-fluid lazy rounded-full">
            <h5 class="card-title pb-2 pt-4">Aduca for Business</h5>
