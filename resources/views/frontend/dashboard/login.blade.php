      ...
      <div class="row">
        <div class="mx-auto col-lg-7">
          <div class="card card-item">
            <div class="card-body">
              <h3 class="pb-4 text-center card-title fs-24 lh-35">Login to Your
                Account!</h3>
              ...
              <form method="POST" action="{{ route('login') }}"class="pt-4">
                ...
                <div class="pt-3 pb-4 text-center">
                  <div class="shadow-sm icon-element icon-element-md fs-25">Or
                  </div>
                </div>
                <div class="input-box">
                ...
                <div class="btn-box">
                  <div
                    class="pb-4 d-flex align-items-center justify-content-between">
