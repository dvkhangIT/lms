    ...
    <div class="row">
      <div class="col-lg-3 responsive-column-half">
        <div class="footer-item">
          ...
          <h3 class="fs-20 font-weight-semi-bold pb-2 pt-4">We are on</h3>
      ...
      <div class="col-lg-3 responsive-column-half">
        <div class="footer-item">
          ...
          <div class="mobile-app">
            <p class="lh-24 pb-3">Download our mobile app and learn on the go.</p>
            <a href="#" class="d-block hover-s mb-2"><img src="images/appstore.png" alt="App store"
                class="img-fluid"></a>
