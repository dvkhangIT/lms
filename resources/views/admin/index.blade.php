      ...
      <div class="col-12 col-lg-4 d-flex">
        <div class="card radius-10 w-100">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">T-Shirts
              <span class="badge bg-danger rounded-pill">10</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Shoes
              <span class="badge bg-primary rounded-pill">65</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Lingerie
          ...
          <div class="card-body">
            <div class="card radius-10 border shadow-none">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    <p class="text-secondary mb-0">Total Likes</p>
                    <h4 class="my-1">45.6M</h4>
                    <p class="font-13 mb-0">+6.2% from last week</p>
                  </div>
                  <div class="widgets-icons-2 bg-gradient-cosmic ms-auto text-white"><i class='bx bxs-heart-circle'></i>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    ...
                    <p class="font-13 mb-0">+3.7% from last week</p>
                  </div>
                  <div class="widgets-icons-2 bg-gradient-ibiza ms-auto text-white"><i
            ...
            <div class="card radius-10 mb-0 border shadow-none">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    <p class="text-secondary mb-0">Total Shares</p>
                    <h4 class="my-1">85.4M</h4>
                    <p class="font-13 mb-0">+4.6% from last week</p>
                  </div>
      ...
      <div class="col d-flex">
        <div class="card radius-10 w-100">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Pending
              <span class="badge bg-gradient-ibiza rounded-pill">10</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Process
