              ...
              <div class="card-body p-sm-5">
                <div class="">
                  ...
                  <div class="list-inline contacts-social text-center">
                    <a href="javascript:;" class="list-inline-item bg-facebook rounded-3 border-0 text-white"><i
                        class="bx bxl-facebook"></i></a>
                    <a href="javascript:;" class="list-inline-item bg-twitter rounded-3 border-0 text-white"><i
                        class="bx bxl-twitter"></i></a>
                    <a href="javascript:;" class="list-inline-item bg-google rounded-3 border-0 text-white"><i
                        class="bx bxl-google"></i></a>
                    <a href="javascript:;" class="list-inline-item bg-linkedin rounded-3 border-0 text-white"><i
