                ...
                <div class="btn-box col-lg-12">
                  <div class="custom-control custom-checkbox mb-4 fs-15">
                    ...
                    <label class="custom-control-label custom--control-label"
                      for="agreeCheckbox">I agree to the
              ...
              <div class="payment-option-wrap">
                <div class="payment-tab is-active">
                  <div class="payment-tab-toggle">
                    <input checked="" id="bankTransfer" name="radio"
                      type="radio" value="handcash" name="cash_delivery">
                    <label for="bankTransfer">Direct Payment</label>
                  </div>
                  <div class="payment-tab-toggle">
                    <input checked="" id="bankTransfer" name="radio"
                      type="radio" value="stripe" name="cash_delivery">
        ...
        <div class="col-lg-5">
          <div class="card card-item">
            <div class="card-body">
              ...
              <div class="order-details-lists">
                <div
                  ...
                  <div class="media-body">
                    <h5 class="fs-15 pb-2"><a href="course-details.html">The
                        Complete JavaScript Course 2021: From Zero to Expert!</a>
                    </h5>
              ...
              <a href="course-grid.html" class="btn-text"><i
