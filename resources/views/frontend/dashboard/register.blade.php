...
<section class="breadcrumb-area section-padding img-bg-2">
  ...
  <div class="container">
    <div
      class="breadcrumb-content d-flex align-items-center justify-content-between flex-wrap">
      <div class="section-heading">
        <h2 class="section__title text-white">Sign Up</h2>
      </div>
      <ul
        class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex align-items-center flex-wrap">
    ...
    <div class="row">
      <div class="col-lg-7 mx-auto">
        <div class="card card-item">
          <div class="card-body">
            <h3 class="card-title fs-24 lh-35 pb-4 text-center">Create an
              Account and <br> Start Learning!</h3>
            ...
            <form method="POST" class="pt-4"
              ...
              <div class="pb-4 pt-3 text-center">
                <div class="icon-element icon-element-md fs-25 shadow-sm">Or
                </div>
              </div>
              <div class="input-box">
              ...
              <div class="btn-box">
                <div class="custom-control custom-checkbox fs-15 mb-2">
                  <input type="checkbox" class="custom-control-input"
                    id="receiveCheckbox" required="">
                  <label
                    class="custom-control-label custom--control-label lh-20"
                    for="receiveCheckbox">Yes! I want
                    to
                    get the most out of Aduca by receiving emails with exclusive
                    deals, personal recommendations and
                    learning tips!</label>
                ...
                <div class="custom-control custom-checkbox fs-15 mb-4">
                  ...
                  <label class="custom-control-label custom--control-label"
                    for="agreeCheckbox">by signing i agree
                    to
                    the
                    <a href="terms-and-conditions.html"
                      class="text-color hover-underline">terms and
                      conditions</a>
                    and
                ...
                <button class="btn theme-btn" type="submit">Register Account
                  <i class="la la-arrow-right icon ml-1"></i></button>
                <p class="fs-14 pt-2">Already have an account? <a
                    href="login.html" class="text-color hover-underline">Log
                    in</a></p>
              </div><!-- end btn-box -->
            </form>
          </div><!-- end card-body -->
