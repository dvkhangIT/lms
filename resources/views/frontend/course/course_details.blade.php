      ...
      <div class="mr-auto col-lg-8">
        <div class="breadcrumb-content">
          ...
          <div class="section-heading">
            ...
            <p class="pt-2 section__desc lh-30">Learn Java In This Course And Become a Computer Programmer. Obtain
              valuable Core Java Skills And Java Certification</p>
          ...
          <div class="flex-wrap d-flex align-items-center">
            <p class="pr-3 d-flex align-items-center">
              <svg class="mr-1 svg-icon-color-gray" width="16px" viewBox="0 0 24 24">
                <path
          ...
          <div class="pt-3 bread-btn-box">
            ...
            <button class="mb-2 mr-2 btn theme-btn theme-btn-sm theme-btn-transparent lh-28" data-toggle="modal"
              data-target="#shareModal">
              <i class="mr-1 la la-share"></i>Share
            </button>
            <button class="mb-2 btn theme-btn theme-btn-sm theme-btn-transparent lh-28" data-toggle="modal"
          ...
          <div class="course-details-content-wrap pt-90px">
            <div class="p-4 rounded course-overview-card bg-gray">
              ...
              <ul class="generic-list-item overview-list-item">
                <li><i class="mr-1 text-black la la-check"></i> Learn the core Java skills needed to apply for Java
                  developer positions in just 14 hours.</li>
                <li><i class="mr-1 text-black la la-check"></i> Be able to demonstrate your understanding of Java to
                  future employers.</li>
                <li><i class="mr-1 text-black la la-check"></i> Acquire essential java basics for transitioning to the
                  Spring Framework, Java EE, Android development and more.</li>
                <li><i class="mr-1 text-black la la-check"></i> Be able to sit for and pass the Oracle Java Certificate
                  exam if you choose.</li>
                <li><i class="mr-1 text-black la la-check"></i> Learn industry "best practices" in Java software
                  development from a professional Java developer who has worked in the language for 18 years.</li>
            ...
            <div class="course-overview-card">
              ...
              <p class="pb-2 fs-15">Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an
                unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not
                only five centuries, Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an
                unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              <p class="pb-2 fs-15">It has survived not only five centuries, but also the leap into electronic
              ...
              <p class="pb-1 fs-15">- Lorem ipsum dolor sit amet, consectetur.</p>
              <p class="pb-1 fs-15">- Lorem ipsum dolor sit amet, consectetur.</p>
              <p class="pt-3 pb-2 fs-15 lh-22"><strong class="text-black font-weight-semi-bold">Are you aiming to get
                  your first Java Programming job but struggling to find out what skills employers want</strong> and which
                course will give you those skills?</p>
              <p class="pb-2 fs-15">This course is designed to give you the Java skills you need to get a job as a Java
                developer. By the end of the course, you will understand Java extremely well and be able to build your own
                Java apps and be productive as a software developer.</p>
              <div class="collapse" id="collapseMore">
                <p class="pb-2 fs-15">The core java material you need to learn java development is covered in the first
                  seven sections (around 14 hours in total). The Java Basics are covered in those sections. The rest of
                  the course covers intermediate, advanced, and optional material you do not technically need to go
                  through.</p>
            ...
            <div class="course-overview-card">
              <div class="pb-4 curriculum-header d-flex align-items-center justify-content-between">
                ...
                <div class="curriculum-duration fs-15">
                  <span class="mr-2 curriculum-total__text"><strong
                      class="text-black font-weight-semi-bold">Total:</strong> 17 lectures</span>
                  <span class="curriculum-total__hours"><strong class="text-black font-weight-semi-bold">Total
                      hours:</strong> 02:35:47</span>
                </div>
              </div>
                ...
                <div id="accordion" class="generic-accordion">
                  ...
                  <div class="card">
                    <div class="card-header" id="headingTwo">
                      <button class="btn btn-link collapsed d-flex align-items-center justify-content-between"
                ...
                <div class="media media-card">
                  <div class="instructor-img">
                    <a href="teacher-detail.html" class="media-img d-block">
                      <img class="lazy" src="images/img-loading.png" data-src="images/small-avatar-1.jpg"
                        alt="Avatar image">
                    </a>
                  ...
                  <div class="media-body">
                    ...
                    <p class="pb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                    ...
                    <div class="collapse" id="collapseMoreTwo">
                      <p class="pb-3">After learning the hard way, Tim was determined to become the best teacher he
                        could, and to make his training as painless as possible, so that you, or anyone else with the
                        desire to become a software developer, could become one.</p>
                      <p class="pb-3">If you want to become a financial analyst, a finance manager, an FP&A analyst, an
                        investment banker, a business executive, an entrepreneur, a business intelligence analyst, a data
                        analyst, or a data scientist, <strong class="text-black font-weight-semi-bold">Tim Buchalka's
                          courses are the perfect course to start</strong>.</p>
                    </div>
                    <a class="collapse-btn collapse--btn fs-15" data-toggle="collapse" href="#collapseMoreTwo"
                      role="button" aria-expanded="false" aria-controls="collapseMoreTwo">
                      <span class="collapse-btn-hide">Show more<i class="ml-1 la la-angle-down fs-14"></i></span>
                      <span class="collapse-btn-show">Show less<i class="ml-1 la la-angle-up fs-14"></i></span>
                    </a>
                  </div>
              ...
              <div class="review-wrap">
                ...
                <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                  <div class="mr-4 rounded-full media-img">
                    <img class="rounded-full lazy" src="images/img-loading.png" data-src="images/small-avatar-1.jpg"
                      alt="User image">
                  </div>
                  <div class="media-body">
                    ...
                    <p class="pb-2">This is one of the best courses I have taken in Udemy. It is very complete, and it
                      has made continue learning about Java and SQL databases as well.</p>
                    <div class="helpful-action">
                      <span class="d-block fs-13">Was this review helpful?</span>
                      <button class="btn">Yes</button>
                      <button class="btn">No</button>
                      <span class="pl-1 cursor-pointer btn-text fs-14" data-toggle="modal"
                ...
                <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                  <div class="mr-4 rounded-full media-img">
                    <img class="rounded-full lazy" src="images/img-loading.png" data-src="images/small-avatar-2.jpg"
                      alt="User image">
                  </div>
                  <div class="media-body">
                    <div class="flex-wrap pb-1 d-flex align-items-center justify-content-between">
                ...
                <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                  <div class="mr-4 rounded-full media-img">
                    <img class="rounded-full lazy" src="images/img-loading.png" data-src="images/small-avatar-3.jpg"
                      alt="User image">
                  </div>
                  <div class="media-body">
                    <div class="flex-wrap pb-1 d-flex align-items-center justify-content-between">
              ...
              <div class="card-body">
                <div class="preview-course-video">
                  <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                    <img src="images/img-loading.png" data-src="images/preview-img.jpg" alt="course-img"
                ...
                <div class="preview-course-feature-content pt-40px">
                  ...
                  <div class="buy-course-btn-box">
                    <button type="button" class="mb-2 btn theme-btn w-100"><i
                        class="mr-1 la la-shopping-cart fs-18"></i> Add to cart</button>
                    <button type="button" class="mb-2 btn theme-btn w-100 theme-btn-white"><i
                        class="mr-1 la la-shopping-bag"></i> Buy this course</button>
                  </div>
                  ...
                  <div class="preview-course-incentives">
                    ...
                    <div class="pt-4 buy-for-team-container">
                      ...
                      <a href="for-business.html"
                        class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30 w-100">Try Aduca for Business</a>
                    </div>
              ...
              <div class="card-body">
                ...
                <ul class="generic-list-item generic-list-item-flash">
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-clock text-color"></i>Duration</span> 2.5 hours</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-play-circle-o text-color"></i>Lectures</span> 17</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-file-text-o text-color"></i>Resources</span> 12</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-bolt text-color"></i>Quizzes</span> 26</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-eye text-color"></i>Preview Lessons</span> 4</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-language text-color"></i>Language</span> English</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-lightbulb text-color"></i>Skill level</span> All levels</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-users text-color"></i>Students</span> 30,506</li>
                  <li class="d-flex align-items-center justify-content-between"><span><i
                        class="mr-2 la la-certificate text-color"></i>Certificate</span> Yes</li>
                </ul>
              </div>
            </div><!-- end card -->
            <div class="card card-item">
              ...
              <div class="card-body">
                ...
                <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                  <a href="course-details.html" class="media-img">
                    <img class="mr-3 lazy" src="images/img-loading.png" data-src="images/small-img-2.jpg"
                ...
                <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                  <a href="course-details.html" class="media-img">
                    <img class="mr-3 lazy" src="images/img-loading.png" data-src="images/small-img-3.jpg"
                      alt="Related course image">
                  </a>
                  <div class="media-body">
                ...
                <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                  <a href="course-details.html" class="media-img">
                    <img class="mr-3 lazy" src="images/img-loading.png" data-src="images/small-img-4.jpg"
                      alt="Related course image">
                  </a>
                  <div class="media-body">
          ...
          <div class="copy-to-clipboard">
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="shadow-none btn theme-btn theme-btn-sm copy-btn"><i class="mr-1 la la-copy"></i>
                  Copy</button>
              </div>
            </div>
      ...
      <div class="modal-content">
        <div class="modal-header border-bottom-gray">
          <div class="pr-2">
            ...
            <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by Aduca staff to determine whether it violates Terms
              of Service or Community Guidelines. If you have a question or technical issue, please contact our
